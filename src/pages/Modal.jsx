...
function Modal({ setShowModal, fetchWeather, fetchForecast, location, setLocation, setFirstBox }) {
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto bg-gray-500 bg-opacity-70 flex flex-col justify-center items-center">
      <div className="border border-black rounded-lg p-8 relative  mx-auto"
      style={{
        background:
        ...
        <h1 className="text-2xl font-bold mb-4 text-center text-white">Get Weather</h1>
        <input
          type="text"
        ...
        />
        <button className="bg-white mx-auto text-black px-4 py-2 rounded-xl font-semibold"
